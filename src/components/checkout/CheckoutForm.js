...
import {getFormattedCart, createCheckoutData,} from "@/lib/functions";
    ...
    return (
        <>
            {cart ? (
                ...
                <p className="text-sm">Please add some products to your cart.</p>   
                <div className='mt-4 w-3xs'>
                <Link href="/" className="bg-purple-600 text-center text-white px-5 py-3 rounded-sm w-auto xl:w-full mt-4 inline-block">
                    Go to Shop
                </Link>
                </div>
                </div>}
